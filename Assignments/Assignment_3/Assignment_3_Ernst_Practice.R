...
letters == "a"
letters != "c"
#Looks for every element in the left side and if it's found in the right
...
# Box plot because Species is a factor and not a number
...
iris_even_rows <- iris[seq(2, nrow(iris), by = 2), ]
print(iris_even_rows)
